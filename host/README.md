...
- [ESPress GUI (`espress_gui_qt.py`)](#espress-gui-espress_gui_qtpy)
...
The `espress_serial.py` module can be used independently from the GUI:
...
```python
from espress_serial import VOICES
...
```python
from espress_serial import build_espress_prefix

# Build inline command prefix
prefix = build_espress_prefix(voice="Harry", rate=150, pitch=90)

...
#define TLV320_HP_POP_DIAGNOSTIC_VALUE   0xBE // bit7: wait-for-powerdown, bits[6:3]: 0x7 (304 ms), bits[2:1]: 0x3 (3.9 ms ramp)
...
// (configureHeadphonePop(), setSpeakerWaitTime(), headphoneLineout()) so
// headphone clarity can be evaluated without changing speaker behavior.
